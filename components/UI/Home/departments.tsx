    ...
    <section className="my-20 grid md:grid-cols-2 gap-10 container">
      ...
      <div className="flex gap-2 items-center">
        <div className="space-y-1">
          <div className="sm:p-2 p-1 border rounded-xl hover:text-primary cursor-pointer" onClick={scrollUp}>
            <CgChevronUp size={28} />
          </div>
          <div className="sm:p-2 p-1 border rounded-xl hover:text-primary cursor-pointer" onClick={scrollDown}>
            <CgChevronDown size={28} />
          </div>
        </div>
        <div className="flex-grow relative after:content-[''] after:absolute after:top-0 after:left-0 after:w-full after:h-[100px] after:bg-gradient-to-b after:from-[#f8f8f8] before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-full before:h-[100px] before:bg-gradient-to-b before:to-[#f8f8f8] before:from-transparent">
          <div
          ...
          >
            {departments.map(({ image, name }, id) => (
              <div key={id} className="bg-white shadow-lg rounded-xl text-center p-10 space-y-2">
