...
const ProfileImageModal = () => {
  ...
  return (
    <Modal onClose={hideModal} className="p-20 bg-white dark:bg-white/10 rounded-xl shadow-2xl space-y-4">
      ...
      <div className="grid place-content-center">
        {!blob ? (
          <Button text="Pick File" icon={<FaRegImage />} variant="filled" onClick={pickFile} />
        ) : (
          <Button
            text="Upload"
            icon={<FaUpload />}
