      ...
      <article className="relative flex w-full">
        <div className="relative flex w-full max-sm:hidden">
          {Array.from({ length: 4 }).map((img, index) => (
            <Image
              key={index}
              src={"/images/avatars/avatar-1.jpeg"}
              alt="attendees"
              width={40}
              height={40}
        ...
        {!isPreviousMeeting && (
          <div className="flex gap-2">
            <Button
              ...
              icon={buttonIcon1 ? <Image src={buttonIcon1} alt="feature" width={20} height={20} /> : undefined}
              text={`${buttonText}`}
            />
            <Button
              onClick={() => {
              ...
              text="Copy Link"
              icon={<Image src="/icons/copy.svg" alt="feature" width={20} height={20} />}
            ></Button>
          </div>
        )}
      </article>
