...
import { approveKyc, rejectKyc } from "@/lib/services/doctor.service";
...
const KycModal: FC<Props> = (data) => {
  ...
  return (
    <Modal
      onClose={hideModal}
      className="bg-white dark:bg-[#282828] shadow-xl rounded-xl lg:min-w-[40rem] min-h-[20rem] max-h-[40rem] overflow-y-auto p-4"
    >
