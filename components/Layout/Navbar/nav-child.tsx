  ...
  return (
    <div className="relative flex items-center gap-1 cursor-pointer group" ref={ref}>
      ...
      {link.children && hovered && (
        <motion.div
          {...fadeToBottomVariant}
          className="absolute top-full left-0 bg-white dark:bg-[#282828] text-gray-900 dark:text-gray-300 shadow-lg rounded-md w-52 overflow-hidden divide-y dark:divide-white/10 divide-black/30"
        >
