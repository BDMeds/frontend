  ...
  return (
    <div className="relative flex items-center gap-1 cursor-pointer group" ref={ref}>
      ...
      {link.children && hovered && (
        <motion.div
          {...fadeToBottomVariant}
          className="absolute top-full left-0 bg-white dark:bg-white/10 text-gray-900 shadow-lg rounded-md w-52 overflow-hidden divide-y dark:divide-white/10 divide-black/30"
        >
